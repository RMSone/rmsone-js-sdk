...
exports.upload = function(req, res) {
   ...
   // var sourcebasedirectory = 'C:/Users/csarkar/Desktop/personal/';
    ...
    for(var i=0;i<uploadfiles.length ; i++){
        ...
        var target = targetbasedirectory + folderpath + "/" +filename;

        mkdirp( targetbasedirectory + folderpath, function (err) {
