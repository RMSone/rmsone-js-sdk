define(['app','main'], function (app,main) {
    'use strict';

    /*
     *  Service to manage all request sent to the RAL API for entity management
     */
    app.factory('EntityManagementService', ['$http', '$q', function ($http, $q) {
        ...
        function createEntity(entity) {
            ...
            if (entity.name !== null && entity.description !== null) {
                main.RMSSDK.swagger.entity.addEntity({
        ...
        function getEntities() {
            var deferred = $q.defer();
//            main.RMSSDK.swagger.entity.getEntities({}, function (data) {
//                cachedData = JSON.parse(data.data);
//                deferred.resolve(cachedData);
//            }, function (error) {
//                cachedData = [];
...
//            if (id !== null) {
//                main.RMSSDK.swagger.entity.getEntityById({
//                    'entityId': id
//                }, function (data) {
//                    cachedData = JSON.parse(data.data);
//                    deferred.resolve(cachedData);
...
//            }
        ...
        function updateEntity(id, entity) {
            ...
            if (entity.name !== null && entity.description !== null) {
                ...
                main.RMSSDK.swagger.entity.updateEntity({
                    'entityId': id,
                    body: JSON.stringify(entity)
                }, function (data) {
                    cachedData = JSON.parse(data.data);
        ...
        function deleteEntity(id) {
            ...
            if (id !== null) {
                main.RMSSDK.swagger.entity.deleteEntity({
                    'entityId': id
                }, function (data) {
                    deferred.resolve({
                        status: data.status
